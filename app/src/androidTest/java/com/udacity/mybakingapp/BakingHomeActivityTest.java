...
public class BakingHomeActivityTest {
    ...
    public void bakingHomeActivityTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tvStepName), withText("Recipe Introduction"),
                        childAtPosition(
                                allOf(withId(R.id.llStep),
                                        childAtPosition(
                                                withId(R.id.rvRecipeList),
                                                0)),
                                0),
                        isDisplayed()));
